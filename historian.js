...
function historianHysteria(input) {
    ...
    for (let num of rightList) rightMap.set(num, (rightMap.get(num) || 0) + 1);
    for (let num of leftList) {
        const countsInRight = rightMap.get(num) || 0;
        similaritScore += num * countsInRight;
    };
    return similaritScore;
};
